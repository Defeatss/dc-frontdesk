...
RegisterServerEvent('dc-frontdesk:server:AlertCooldown', function(job, bool)
...
QBCore.Functions.CreateCallback('dc-frontdesk:server:CooldownCheck',function(source, cb, job)
    local src = source
